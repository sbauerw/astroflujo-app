...
export default function ResultPage() {
  ...
  const generateReading = async (data: AstroData) => {
    try {
      ...
      setError('Hubo un error al generar tu lectura. Por favor, contacta a soporte.')
      console.error(err)
    } finally {
      setLoading(false)
    }
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mt-12 space-y-4">
          <p className="text-white/60 text-sm">
            ✨ Lectura generada con inteligencia artificial
          </p>
          <p className="text-white/50 text-xs max-w-2xl mx-auto">
            Esta lectura tiene fines de entretenimiento y crecimiento personal. 
            No sustituye asesoramiento profesional médico, legal o financiero.
          </p>
          <button
            onClick={() => router.push('/')}
